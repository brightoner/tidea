...
<script type="text/javascript">
	...
	function fn_inputNdetailCompoSetting(){
			...
			fn_compoInputbox('M', 'I', 'inputNdetail_6_1', 'OFFICE_REG_NO', 'OFFICE_REG_NO', '', '사업자등록번호', '', '30');
	}
...
<body>
	<form name="form" method="post">
		...
		<div class="box-blue-line clear relative">
			...
			<div id="buttonDivBox" class="button_box">
				<button type="button" id="saveBtn" onclick="javascript:fn_save();return false;"><span></span><c:out value="저장" /></button><!-- 저장버튼 -->
				<button type="button" id="goListBtn" onclick="javascript:fn_goList();return false;"><span></span>로그인화면으로 이동</button>
			</div>
			<!-- 상단버튼 영역 END -->
			...
			<div id="inputNdetailDivBox" class="inputNdetail">
				...
				<div class="inputNdetail_box">
					<div class="row clear">
						...
						<button type="button" onclick="javascript:fn_idChek();" style="margin-top: 5px;"><b>아이디중복확인</b></button>
					</div>
					...
					<div class="row clear">
						<div id="inputNdetail_4_1" class="col clear">
							...
							<div class="right">
								<input type="text" id="INSER_USER_EMAIL" name="INSER_USER_EMAIL" value="" maxlength="30" style="ime-mode:active"> 
							</div>
						</div>
					...
					<div class="row clear">
						<div id="inputNdetail_6_1" class="col clear">
							...
							<div class="right">
								<input type="text" id="OFFICE_REG_NO" name="OFFICE_REG_NO" value="" maxlength="30" style="ime-mode:active"> 
							</div>
						</div>
					</div>
				</div>	
	...
	function newUpchk(flag){
		if (flag == true) {
			...
			$('#OFFICE_REG_NO').val('').attr('readonly', false);
