...
.error_container_1{position:relative; width:620px; height:384px; margin:80px auto 0 auto; background:url(/resources/images/error_bg_2.jpg) left top no-repeat;}
...
<div class="error_wrap">
	<div class="error_container_1">
		...
		<div class="error_text_1">
			...
			<br/><strong>올바른 경로</strong>로 <strong>요청</strong>하셨는지 확인 바랍니다!
		</div>
		<!-- //에러메시지 텍스트 -->
